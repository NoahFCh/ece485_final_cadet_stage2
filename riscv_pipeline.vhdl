...
----------------------------------------------------------------------------------------
    ...
    -- Comparator 
    not_equal_flag <= '1' when ex_mem_branch = '1' and ex_mem_alu_result /= x"00000000" else '0';
    
    next_pc <= std_logic_vector(signed(ex_mem_npc) + signed(ex_mem_imm)) when (not_equal_flag = '1') else -- branch case
...
------------------------------------------------------------------------------------------
    ...
    wb_data <= mem_wb_mem_data when (mem_wb_mem_read = '1') else 
               ...
               mem_wb_alu_result when (mem_wb_reg_write = '1' and mem_wb_load_addr = '0');      
